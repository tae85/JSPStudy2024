...
public class BoardPage {
    ...
    public static String pagingParam(int totalCount, int pageSize, int blockPage,
        ...
        if (pageTemp != 1) {
    		...
    		if(map.get("searchWord") != null && map.get("searchWord") != "") {
            	...
            	pagingStr += "'><img src='../images/paging1.gif'/></a>";
            }        
            pagingStr += "&nbsp;";
            pagingStr += "<a href='" + reqUrl + "?pageNum=" + (pageTemp - 1);
    		if(map.get("searchWord") != null && map.get("searchWord") != "") {
            	...
            	pagingStr += "'><img src='../images/paging2.gif'/></a>";
            }
        }
        ...
        if (pageTemp <= totalPages) {
    		...
    		if(map.get("searchWord") != null && map.get("searchWord") != "") {
            	...
            	pagingStr += "'><img src='../images/paging4.gif'/></a>";
            }
        }
